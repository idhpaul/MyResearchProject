...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_route_5fguide_2eproto = {
  false, false, descriptor_table_protodef_route_5fguide_2eproto, "route_guide.proto", 709,
...
static bool dynamic_init_dummy_route_5fguide_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_route_5fguide_2eproto)), true);
namespace routeguide {
